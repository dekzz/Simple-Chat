...
namespace ChatServerApp
{
    ...
    class ChatServer
    {
        ...
        public static void AddUser(TcpClient tcpUser, string strUsername)
        {
            ...
            SendAdminMessage(htConnections[tcpUser] + " has joined the chat.");
        }
        ...
        public static void RemoveUser(TcpClient tcpUser)
        {
            ...
            {
                SendAdminMessage(htConnections[tcpUser] + " has left the chat.");
    ...
    class Connection
    {
        ...
        private void AcceptClient()
        {
            ...
            if (currUser != "")
            {
                ...
                {
                    swSender.WriteLine("0|Nickname already taken.");
                    swSender.Flush();
                    CloseConnection();
                    return;
                }
                ...
                {
                    swSender.WriteLine("0|Name reserved.");
                    swSender.Flush();
                    CloseConnection();
                    return;
                }
